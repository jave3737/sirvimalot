...
| editing     | [easy-align](https://github.com/junegunn/vim-easy-align)                               |
| editing     | [surround](https://github.com/tpope/vim-surround)                                      |
...
| utility     | [peekaboo](https://github.com/junegunn/vim-peekaboo)                                   |
...
| configuration            |                | :set                                | :set option?                    | list (all/the current option) the settings currently configured                                                                                               |
...
| editing                  |                | viw                                 |                                 | highlight the current word the cursor is in                                                                                                                   |
| editing                  |                | ciw                                 | diw                             | (change/delete) the current word the cursor is in, (brings you right into insert mode/leaves you in normal mode)                                              |
...
```
## how do i set a keymap only for the local buffer 
* you have to prepend `buffer`
```vimscript
